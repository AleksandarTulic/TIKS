...
/*
 * Description: Here we test if the link View Student works after adding one student.
 * 
 * */

public class InputTestLink_ViewStudent {
	WebDriver driver;
	...
	@Test
	@DisplayName("Input - Test Link ViewStudent")
	public void InputTestLinkViewStudent() {
	    ...
	    assertThat("http://localhost:4200/view-student", is(url));
	}
}
