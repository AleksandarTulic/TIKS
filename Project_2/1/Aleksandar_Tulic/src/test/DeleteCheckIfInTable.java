...
/*
 * Description: Here we test if the number of students in table(list) is changed in the right way 
 * after deleting a student
 * 
 * */

public class DeleteCheckIfInTable {
	WebDriver driver;
	...
	@Test
	@DisplayName("Delete - Check If It Is In Table")
	public void deleteCheckIfInTable() {
