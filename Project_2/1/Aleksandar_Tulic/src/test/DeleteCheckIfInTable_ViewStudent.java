 ...
 * than it was before we deleted one student(using link: View Student)
 * 
 * */

public class DeleteCheckIfInTable_ViewStudent {
	WebDriver driver;
	...
	@Test
	@DisplayName("Delete - Check If In Table after View Student link")
	public void deleteCheckIfInTable_ViewStudent() {
