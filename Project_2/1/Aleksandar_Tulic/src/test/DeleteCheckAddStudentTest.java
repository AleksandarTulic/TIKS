 ...
 * So here we use Add Student link to jump to some other place and get right back to check if it changed.
 * 
 * */

public class DeleteCheckAddStudentTest {
	WebDriver driver;
	...
	@Test
	@DisplayName("Delete - Add Student Refresh Check")
	public void deleteCheckAddStudent() {
